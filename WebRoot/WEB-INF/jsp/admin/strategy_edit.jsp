			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/updateParkById" enctype="multipart/form-data" onsubmit="return check(this)">
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead">景区名称 </label>
							  <div class="controls">
								<input type="text" name="parkName" class="span6 typeahead" id="typeahead" value="${park.parkName}" readonly="readonly" data-provide="typeahead" data-items="4" >
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" name="cityName" class="span6 typeahead" id="typeahead" value="${park.cityName}" data-provide="typeahead" data-items="4" >		
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" name="bestMonth" id="date01" value="${park.bestMonth}">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" name="suitPeople" value="${park.suitPeople}" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" >
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <select id="selectError" name="tourType" data-rel="chosen" >
									...
									<option value="0" <c:if test="${park.tourType==0}">selected="selected"</c:if>>人文古迹</option>
									<option value="1" <c:if test="${park.tourType==1}">selected="selected"</c:if>>自然风光</option>
									<option value="2" <c:if test="${park.tourType==2}">selected="selected"</c:if>>游乐园</option>
								  </select>
								</div>
							  </div>							          
							<div class="control-group">
							  ...
							  <div class="controls">
								<textarea name="parkIntroduce" id="textarea2" rows="5" cols="10">${park.parkIntroduce}</textarea>
							  </div>
							</div>																
							<div class="form-actions">
							  <button type="submit" class="btn btn-primary">修改攻略</button>
