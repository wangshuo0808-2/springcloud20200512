	...
	<script type="text/javascript">
		$(function(){
			$("#button").click(function(){
     		...
     		$.get("${pageContext.request.contextPath}/notice/update",data,function(result){
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" id="form100" action="${pageContext.request.contextPath}/notice/update">
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead">标题 </label>
							  <div class="controls">
								<input type="text" class="span6 name="title" value="${notice.title}"typeahead" id="typeahead"  data-provide="typeahead" data-items="4" data-source='["Alabama","Alaska","Arizona","Arkansas","California","Colorado","Connecticut","Delaware","Florida","Georgia","Hawaii","Idaho","Illinois","Indiana","Iowa","Kansas","Kentucky","Louisiana","Maine","Maryland","Massachusetts","Michigan","Minnesota","Mississippi","Missouri","Montana","Nebraska","Nevada","New Hampshire","New Jersey","New Mexico","New York","North Dakota","North Carolina","Ohio","Oklahoma","Oregon","Pennsylvania","Rhode Island","South Carolina","South Dakota","Tennessee","Texas","Utah","Vermont","Virginia","Washington","West Virginia","Wisconsin","Wyoming"]'>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<textarea class="cleditor" id="textarea2" rows="10" cols="50"  name="content">${notice.content}</textarea>
							  </div>
							</div>
							<div class="form-actions">
							<input type="hidden" name="id" value="${notice.id}"/>
							  <input type="button" value="修改公告" class="btn btn-primary" id="button">
