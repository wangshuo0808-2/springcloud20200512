						...
						<form class="form-horizontal">
						  ...
						  <div class="box-content">
							<ul class="dashboard-list">
								...
								<li>
									<strong>生日:</strong> <fmt:formatDate value="${user.birthday}" pattern="yyyy-MM-dd"/><br>
									<strong>QQ:</strong> ${user.QQ }<br>
									<strong>手机:</strong> ${user.telephone}<br>
									<strong>所在地:</strong>${user.addressCity}</span>                   
								</li>
								<%--<li>
							...
							<div class="form-actions">
									<a class="btn btn-success" href="${pageContext.request.contextPath}/user/list">
										<i class="icon-repeat icon-white"></i> 
										返回列表
									</a>								
									<a class="btn btn-danger" name="del" id="${user.userId}" >
