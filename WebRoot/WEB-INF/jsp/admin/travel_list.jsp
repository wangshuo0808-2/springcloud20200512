	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/jquery-2.1.4.min.js"></script>
  	<script type="text/javascript">
  		$(function(){
			...
			//提示是否删除
			if(confirm("确定删除旅游记忆信息吗?")){
				$.get("${pageContext.request.contextPath}/memory/delete",{"id":id},
					function(result){
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						...
						--%><form action="${pageContext.request.contextPath}/memory/list">
				    ...
				    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                      ...
                      <c:forEach items="${page.list}" var="u">
                        <tr>
                          <td>${u.title }</td>
                          <td class="center"><fmt:formatDate value="${u.submitTime }" pattern="yyyy-MM-dd"/></td>
                          <td class="center">${u.userName}</td>
                          <td class="center"><a class="btn btn-success" href="${pageContext.request.contextPath}/memory/detail?id=${u.travelMemoryId}"> <i class="icon-zoom-in icon-white"></i> View </a> <a class="btn btn-danger" href="#" name="del" id=${u.travelMemoryId}> <i class="icon-trash icon-white"></i> Delete </a> </td>
                        </tr>
                        </c:forEach>
                        <tr>
							<td align="center" colspan="4">
    			<c:if test="${page.pageNo>1}">
    			<a href="${pageContext.request.contextPath}/memory/list?title=${title}&pageNo=1">首页</a>
    			<a href="${pageContext.request.contextPath}/memory/list?title=${title}&pageNo=${page.pageNo-1}">上一页</a>
    			</c:if>
    			<c:if test="${page.pageNo<=1}">
				<a >首页</a>
				<a >上一页</a>
    			...
    			<a href="${pageContext.request.contextPath}/memory/list?title=${title}&pageNo=${page.pageNo+1}">下一页</a>
    			<a href="${pageContext.request.contextPath}/memory/list?title=${title}&pageNo=${page.totalPageCount}">末页</a>
    			</c:if>
				<c:if test="${page.pageNo>=page.totalPageCount}">
				<a >下一页</a>
				<a >末页</a>
