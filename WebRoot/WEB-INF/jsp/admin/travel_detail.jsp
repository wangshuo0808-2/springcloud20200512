				...
				$.get("${pageContext.request.contextPath}/memory/delete",{"id":id},
					function(result){
						if(result.row=="success"){
							alert("删除成功！")
							location.href="${pageContext.request.contextPath}/memory/list";
						}
					})
			}
		})
						  ...
						  <fieldset>
							...
							<div class="control-group">
							  <label class="control-label" for="textarea2">发布时间</label>
							   <label class="control-label" for="textarea2"><fmt:formatDate value="${memory.submitTime }" pattern="yyyy-MM-dd hh:mm"/></label>
							</div>
							<div class="control-group">
							...
							<div class="form-actions">
									<a class="btn btn-success" href="${pageContext.request.contextPath}/memory/list">
										<i class="icon-repeat icon-white"></i> 
										返回列表
									</a>								
									<a class="btn btn-danger" href="#" name="del" id=${memory.travelMemoryId }>
