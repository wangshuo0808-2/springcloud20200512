	...
	<!-- topbar ends -->
		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
						  	<c:forEach items="${page.list}" var="no">
							<tr>
								<td>${no.title }</td>
								<td class="center"><fmt:formatDate value="${no.releaseTime}" pattern="yyyy-MM-dd hh:mm"/>    </td>
								<td class="center">${no.announcer}</td>
								<td class="center">
									<a class="btn btn-info" href="${pageContext.request.contextPath}/notice/detail?id=${no.id}">
										<i class="icon-edit icon-white"></i>  
										Edit                                            
									</a>
									<a class="btn btn-danger" href="#" name="del" id=${no.id}>
    			...
    			<a href="${pageContext.request.contextPath}/notice/list?title=${title}&pageNo=1">首页</a>
    			<a href="${pageContext.request.contextPath}/notice/list?title=${title}&pageNo=${page.pageNo-1}">上一页</a>
    			</c:if>
    			<c:if test="${page.pageNo<=1}">
				<a >首页</a>
				<a >上一页</a>
    			...
    			<a href="${pageContext.request.contextPath}/notice/list?title=${title}&pageNo=${page.pageNo+1}">下一页</a>
    			<a href="${pageContext.request.contextPath}/notice/list?title=${title}&pageNo=${page.totalPageCount}">末页</a>
    			</c:if>
				<c:if test="${page.pageNo>=page.totalPageCount}">
				<a >下一页</a>
				<a >末页</a>
