...
<div class="header">
    <div class="headWrap">
        ...
        <ul class="dropdown">
            ...
            <li>
				<a href="${pageContext.request.contextPath}/tostrategy.htm">景点攻略</a>
			</li>
		</ul>
						...
						<li class="fn-clear">
							...
							<div class="comment_info fn-right">
								<p>
									...
									<label style="float:right"><a class="comment_user" href="#">同意</a><a class="comment_user" href="#">拒绝</a></label>
								</p>
